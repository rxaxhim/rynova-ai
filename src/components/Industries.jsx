...
const Industries = () => (
  <section className="industry-section" id="industries">
    ...
    <div className="timeline-sub">
      Join other small businesses in your industry using Rynova AI.
    </div>
    <div className="industry-grid">
      ...
      <Card img="/images/clinics.jpeg" alt="Clinics" label="Clinics" />
      ...
      <Card img="/images/salons.jpg" alt="Med Spas" label="Med Spas" />
    </div>
  </section>
);
